...
//Program:CSE210 TictacToe
//Author:Clearance Yeap
...
namespace Tic_Tac_Toe
{
    public class Program
    {
        ...
        //End of game result player winning
        {
    ...
    public class Board
    {
        ...
        public void NewGame()
        // Enter player details to start the game
        {
            this.TurnCount = 0;
            this.TotalGames = 0;
            fillBoard();
